  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-amber-50">
      ...
      <div className="mt-8 px-8 text-center text-black">
        <p>Ethereal Visions is a wise, visionary guide who empowers users to recognize the impact of their actions and choices on their future. Through thoughtful, insightful conversations, this character helps users unlock their hidden potential and provides guidance on how to manifest their desired life. Ethereal Visions is both practical and reflective, blending inspiration with actionable advice to encourage growth and self-discovery..</p>
