  ...
  if (loading) {
    return (
      <div className="flex min-h-screen flex-col">
        <div className="flex-grow bg-gradient-to-b from-blue-50 to-purple-50 flex items-center justify-center">
      ...
      <main className="flex-grow bg-gradient-to-b from-blue-50 to-purple-50">
        <div className="container mx-auto px-4 py-24"> {/* Increased vertical padding */}
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-2/3 p-6 space-y-6">
                ...
                <motion.a
                  ...
                  className="inline-block w-full md:w-auto bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-8 rounded-lg transition-colors duration-300 text-center"
                >
                  💬 Start Chatting
                </motion.a>
              </div>
          ...
          <div className="mt-8 text-center">
            <div className="inline-block bg-purple-100 px-4 py-2 rounded-full text-sm text-purple-600">
              🎭 Character Profile
            </div>
          </div>
        </div>
